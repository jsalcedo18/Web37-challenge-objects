...
Add to the function createMenuItems below so it will create objects following the same format 
found above for latte and breakfastBurrito (name, price, category).  
The function should:
...
*/
console.log(createMenuItem("frenchFries", 4, "sideDish"));
console.log(createMenuItem("steak", 20, "dinner"));
console.log(createMenuItem("corn", 3, "vegtable"));
